...
import reranker_pb2 as reranker__pb2
...
def add_RerankServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'reranker.RerankService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('reranker.RerankService', rpc_method_handlers)
